			...
			if ( Installed )
			  {
			    ...
			    CreateDisplayViewerEx("100%", "100%", "../grf/record_04.grf", "../data/xmlCustomer_04.jsp?date_status="+date_status+"&date_start="+date_start+"&date_end="+date_end+"&institution="+institution, true, "");
			   }
			}
		}
	</script>
