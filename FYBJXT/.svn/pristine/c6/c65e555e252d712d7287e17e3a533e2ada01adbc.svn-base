...
public class CertificateFirstSignService_W {
private DataSource dataSource;
	
	public List<VD301> queryD301(String d301_26, String date_start, String date_end, ServletContext servletContext) {
		...
		String sql = "select * from v_d301 t where t.D301_26 like ? and to_date(t.D301_28,'YYYY-MM-DD') >= to_date(?,'YYYY-MM-DD') and to_date(t.D301_28,'YYYY-MM-DD') <= to_date(?,'YYYY-MM-DD') and t.D301_30 = '2'";
		VD301 vd301 = null;
