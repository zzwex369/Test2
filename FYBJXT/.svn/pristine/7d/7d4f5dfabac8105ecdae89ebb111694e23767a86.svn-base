    ...
    function window_onload() {
		if (_gr_platform.indexOf("64") > 0)
			...
			{	
		    	...
		    	CreateDisplayViewerEx("100%", "100%", "../grf/lasc.grf", "../data/xmlCustomer_19.jsp?institution="+institution+"&address_status="+address_status+"&address="+address+"&date_status="+date_status+"&date_satrt="+date_satrt+"&date_end="+date_end, true, "");
