...
<center>
  <table id="excel" borderColor="#000000" cellSpacing="0" align="center"  border="0">
  	<tr>
  		<td align="left"><h3 align="center">《出生医学证明》换发登记本</h3></td>
  	</tr>
  	<tr>
  		<td>
...
<c:forEach items="${requestScope.vd301s }" var="vd301" varStatus="i">
  <tr>
    ...
    <td nowrap="nowrap" class="txt">${vd301.d30139 }</td>
...
<div align="center">
<form action="/csyxzm/CertificateFirstSignServlet" method="POST">
	...
	<input type="hidden" value="${requestScope.date_start }" name="date_start"/>
		...
		<input type="hidden" value="${requestScope.d30142 }" name="d30142"/>
