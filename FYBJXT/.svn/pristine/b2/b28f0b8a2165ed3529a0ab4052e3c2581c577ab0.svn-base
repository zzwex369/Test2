package com.xyw.sys.custom.component
{
	import mx.controls.Button;
		...
		import com.xyw.sys.custom.component.CheckBoxExtendedIcon;
		...
		*/
		...
		public class CustomCheckBoxExtendedWithButton extends Button
		{
			 ...
			 * 
			 */
			public function CustomCheckBoxExtendedWithButton()
			{
				super();
				_toggle = true;
				centerContent = false;
