...
var href=location.href;//本页路径http://localhost:8080/fybjxt/report_new/jsp/Report_02.jsp?date_start=2017-11-01&date_end=2017-11-03&institution=4113
var pathName=location.pathname;///fybjxt/report_new/jsp/Report_02.jsp
var serverName=pathName.substring(0,pathName.indexOf("/",2)); //  /fybjxt
var grbsctl6Path = href.substring(0,href.indexOf(pathName))+serverName;//ip+端口+项目名称
...
var  gr_CodeBase = _gr_isIE? 'codebase="' + grbsctl6Path + '/grbsctl6'+(_gr_isX64? '/grbsctl6x64.cab' : '/grbsctl6.cab') + '#Version=' + gr_Version + '"' : ""; //区分浏览器(IE or not)
