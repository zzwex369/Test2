...
<head>
    ...
    function window_onload() {
		...
		if ( Installed ){
	    	...
	    	CreatePrintViewerEx("100%", "100%", "../../grf/msbb/msmx.grf", "../../data/msbb/xmlCustomer_msmxb.jsp?"+
	    	"dateStr="+dateStr+"&dateEnd="+dateEnd+"&code="+code+"&payStatus="+payStatus, true, "");
		}
	}
	</script>
</head>
<body onload="window_onload()">
	...
	<input type="hidden" id="payStatus" value="${param.payStatus}"/>
