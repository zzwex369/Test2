    ...
    function window_onload() {
		if (_gr_platform.indexOf("64") > 0)
			...
			if ( Installed )
			{
		    	...
		    	var f30146 = document.getElementById("f30146").value;
		    	var institution = document.getElementById("institution").value;
		    	CreateDisplayViewerEx("100%", "100%", "../grf/record.grf", "../data/xmlCustomer.jsp?"+
		    	"institution="+institution+"&address_status="+address_status+"&address="+address+"&date_status="+date_status+"&f30146="+f30146+"&date_satrt="+date_satrt+"&date_end="+date_end, true, "");
		    }	
		}
	}
	</script>
...
<body onload="window_onload()">
	...
	<input type="hidden" id="f30146" value="${param.f30146}"/>
