...
public interface SystemService {
	...
	boolean setNotice(String d80101,String d80118);
	public PicDataResponse changePicAttribute(PicDataRequest picDataRequest);
	public ServiceDateResponse getServiceDate(ServiceDateRequest serviceDateRequest);
}
