    ...
    function window_onload() {
		if (_gr_platform.indexOf("64") > 0)
			...
			if ( Installed )
			{
		    	...
		    	CreateDisplayViewerEx("100%", "100%", "../grf/record_10.grf", "../data/xmlCustomer_10.jsp?date_status="+date_status+"&date_start="+date_start+"&date_end="+date_end+"&institution="+institution, true, "");
		    }	
		}
	}
	</script>
