...
<head>
<title>新生儿访视率</title>
<!--  http://localhost:7002/fybjxt/chart/etpie01_xsefs.jsp -->
...
<body>
	...
	<div style="height: 400px; width: 980px;">
		...
		<div style="float:right;margin-top: 200px;width: 330px;"><img src="../image/chart_picture/et001_xsefsl.png" /></div>
	</div>
                	    ...
                	    series : [
                	        {
                	            ...
                	            center: ['50%', '60%'],
                	            data:[
                	                {value:350, name:'接受过访视的新生儿数'},
                	                {value:50, name:'未接受过访视的新生儿数'}
                	            ]
                	        }
                	    ]
                };
	...
	<script type="text/javascript">
        function getChartData() {
            ...
            $.ajax({
                type : "post",
                async : false, //同步执行
                url : "${pageContext.request.contextPath}/etpie01_xsefs.do?institution=" + institution + "&date_start=" + date_start + "&date_end=" + date_end,
                data : {},
