    ...
    function window_onload() {
		if (_gr_platform.indexOf("64") > 0)
			...
			{	 
		    	...
		    	CreateDisplayViewerEx("100%", "100%", "../grf/lbzhcx.grf", "../data/xmlCustomer_24.jsp?institution="+institution+"&date_satrt="+date_satrt+"&date_end="+date_end+"&hospital="+hospital+"&chargetype="+chargetype+"&checktype="+checktype+"&date_status="+date_status+"&address_status="+address_status+"&address="+address, true, "");
