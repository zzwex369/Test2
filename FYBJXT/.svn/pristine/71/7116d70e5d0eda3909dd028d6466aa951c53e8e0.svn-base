...
public class CertificateFirstSignService {
	private DataSource dataSource;
	
	public List<VD301> queryD301(String d301_26, String date_start, String date_end, ServletContext servletContext , String d301_42) {
		...
		//StringBuffer sql = "t.D301_42 =? ";

		StringBuffer sql = new StringBuffer("select * from v_d301 t where t.D301_26 like ? and to_date(t.D301_28,'YYYY-MM-DD') >= to_date(?,'YYYY-MM-DD') and to_date(t.D301_28,'YYYY-MM-DD') <= to_date(?,'YYYY-MM-DD') and t.D301_30 = '1' ");
		if("1".equals(d301_42)){
			sql.append(" and t.D301_42 in ('1','3') ");
		}else {
			sql.append(" and t.D301_42 ='"+ d301_42+ "'");
		}
		sql.append(" order by t.d301_28,t.d301_10 ");
		VD301 vd301 = null;
		List<VD301> vd301List = null;
		try {
			connection = this.dataSource.getConnection();
			preparedStatement = connection.prepareStatement(sql.toString());
			preparedStatement.setString(1, d301_26 + (d301_26.length()==14?"":"%"));
			preparedStatement.setString(2, date_start);
			preparedStatement.setString(3, date_end);
			//preparedStatement.setString(4, d301_42);
			...
			while(resultSet.next()) {
				...
				String d30131Zhx = resultSet.getString("D301_31_ZHX");
	...
	//机构外
	public List<VD301> queryD301Jgw(String d301_26, String date_start, String date_end, ServletContext servletContext , String d301_42) {
		...
		PreparedStatement preparedStatement = null;
		ResultSet resultSet = null;
		String sql = "select * from v_d301 t where t.D301_26 like ? and to_date(t.D301_28,'YYYY-MM-DD') >= to_date(?,'YYYY-MM-DD') and to_date(t.D301_28,'YYYY-MM-DD') <= to_date(?,'YYYY-MM-DD') and t.D301_30 = '2' and t.D301_42 =?";
		VD301 vd301 = null;
		List<VD301> vd301List = null;
		try {
			connection = this.dataSource.getConnection();
			preparedStatement = connection.prepareStatement(sql);
			preparedStatement.setString(1, d301_26 + "%");
			preparedStatement.setString(2, date_start);
			preparedStatement.setString(3, date_end);
			preparedStatement.setString(4, d301_42);
