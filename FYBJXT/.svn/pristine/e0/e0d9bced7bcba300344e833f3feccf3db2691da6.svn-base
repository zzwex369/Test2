    ...
    function window_onload() {
		if (_gr_platform.indexOf("64") > 0)
			...
			if ( Installed )
			{
		    	...
		    	CreateDisplayViewerEx("100%", "100%", "../grf/record_06.grf", "../data/xmlCustomer_06.jsp?date_start="+date_start+"&date_end="+date_end+"&institution="+institution, true, "");
		    }			
		}
	}
	</script>
