...
<head>
<title>孕妇健康管理率</title>
<!--  http://localhost:7002/fybjxt/chart/fnpie02_jkgl.jsp -->
...
<body>
	...
	<div style="height: 400px; width: 980px;">
		...
		<div style="float:right;margin-top: 200px;width: 330px;"><img src="../image/chart_picture/fn002_jkgll.png" /></div>
	</div>
                	    ...
                	    series : [
                	        {
                	            ...
                	            center: ['50%', '60%'],
                	            data:[
                	                {value:350, name:'接受5次及以上随访人数'},
                	                {value:50, name:'不足5次或未接受随访人数'}
                	            ]
                	        }
                	    ]
                };
	...
	<script type="text/javascript">
        function getChartData() {
            ...
            $.ajax({
                type : "post",
                async : false, //同步执行
                url : "${pageContext.request.contextPath}/fnpie02_jkgl.do?institution=" + institution + "&date_start=" + date_start + "&date_end=" + date_end,
                data : {},
