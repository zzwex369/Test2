...
<%
	 		...
	 		String trisomy_21 = request.getParameter("trisomy_21");
	 		String NTD = request.getParameter("NTD");
	 		String Age_risk = request.getParameter("Age_risk");
		...
		//单位
				if("".equals(unit)  && "0".equals(address_status)){
					sql.append(" and t.f601_29 in (select a.d101_01 from d101 a where a.d101_19 is not null and a.d101_19='"+hospital+"')");
					}
					if("".equals(unit) && "1".equals(address_status)){
					sql.append(" and t.f601_63 in (select a.d101_01 from d101 a where a.d101_19 is not null and a.d101_19='"+hospital+"')");
				}
				if(!"".equals(unit) && "0".equals(address_status)){
					sql.append(" and t.f601_29='"+unit+"'");
				}
				if(!"".equals(unit) && "1".equals(address_status)){
					sql.append(" and t.f601_63='"+unit+"'");
				}
			...
			if(!"".equals(trisomy_21)){
				sql.append(" and f.f602_16 ='"+trisomy_21+"'");
			}
			
			if(!"".equals(NTD)){
				sql.append(" and f.f602_29 ='"+NTD+"'");
			}
			if(!"".equals(Age_risk)){
				sql.append(" and f.f602_22 ='"+Age_risk+"'");
			}
