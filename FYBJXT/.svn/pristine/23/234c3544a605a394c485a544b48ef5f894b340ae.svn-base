			...
			<div style="width: 800px;text-align:right;">
				...
				<div>
					...
					<c:choose>
						 ...
						 <label style="margin-left:120px;">
						 	乳房：正常
						 <c:choose>
							<c:when test="${vf401.f40163=='1' }">☑</c:when>
							<c:otherwise>☐</c:otherwise>
					</c:choose>	   
					   异常
					    <c:choose>
							<c:when test="${vf401.f40163=='2' }">☑</c:when>
							<c:otherwise>☐</c:otherwise>
						</c:choose>	   
						 <span class="spanAll" style="width:180px">${vf401.f40164}</span>		
					</label>   
					</p>
				</div>
				<div>
					<p>
						生殖器：肛查（常规）：外阴：<span class="spanAll" style="width:120px">${vf401.f40177}</span>
										分泌物：<span class="spanAll" style="width:120px">${vf401.f40178}</span>
					</p>
				</div>
				<div>
					<p>
						<label style="margin-lefg:120px;">
							子宫；<span class="spanAll" style="width:120px">${vf401.f40179}</span>
						</label>
						<label style="margin-lefg:60px;">
							附件；<span class="spanAll" style="width:120px">${vf401.f40180}</span>
						</label>
					</p>
				</div>
				<div>
					<p>
						阴道镜检查（必要时）：外阴：外阴：<span class="spanAll" style="width:80px">${vf401.f40181}</span>
											阴道：<span class="spanAll" style="width:80px">${vf401.f40182}</span>
											宫颈：<span class="spanAll" style="width:80px">${vf401.f40183}</span>
					</p>
				</div>
				<div>
					<p>
						子宫：<span class="spanAll" style="width:280px">${vf401.f40184}</span>
					</p>
				</div>
				<div>
					<p>
						附件：<span class="spanAll" style="width:280px">${vf401.f40185}</span>
					</p>
				</div>
				<div style="width: 800px;">
					<p>
						同意阴道检查，本人签字：<span class="spanAll" style="width:120px"></span>
						<label style="margin-left:120px;">医师签名：<span class="spanAll" style="width:120px"></span></label>
					</p>
				</div>
				<div>
					<p>
				...
				<div>
					<p>
						...
						<br>*																				 <label style="margin-left:600px">*</label>
						<br>*																				 <label style="margin-left:600px">*</label>
						<br>*																				 <label style="margin-left:600px">*</label>
						<br>--------------------------------------------------------------------------------------------------------------------
					</p>
