    ...
    //报表插件目前只能在32位浏览器中使用
		if (_gr_platform.indexOf("64") > 0)
			...
			if ( Installed )
			{
		    	...
		    	CreateDisplayViewerEx("100%", "100%", "../grf/record_02.grf", "../data/xmlCustomer_02.jsp?date_status="+date_status+"&date_start="+date_start+"&date_end="+date_end+"&institution="+institution, true, "");
		    	}
			}
		}
	</script>
