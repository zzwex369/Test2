    ...
    function window_onload() {
		if (_gr_platform.indexOf("64") > 0)
			...
			{	 
		    	...
		    	CreateDisplayViewer("../../grf/fnbj/gjascfwtjb.grf",
		    	 "../../data/fnbj/xmlCustomer_gjascfwtjb.jsp?institution="+institution+"&date_start="+date_start+"&date_end="+date_end);
