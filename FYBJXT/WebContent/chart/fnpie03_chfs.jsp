...
<head>
<title>产后访视率</title>
<!--  http://localhost:7002/fybjxt/chart/fnpie03_chfs.jsp -->
...
<body>
	...
	<div style="height: 400px; width: 980px;">
		...
		<div style="float:right;margin-top: 200px;width: 330px;"><img src="../image/chart_picture/fn003_chfsl.png" /></div>
	</div>
                	    ...
                	    series : [
                	        {
                	            ...
                	            center: ['50%', '60%'],
                	            data:[
                	                {value:350, name:'接受过产后访视的人数'},
                	                {value:50, name:'未接受过产后访视人数'}
                	            ]
                	        }
                	    ]
                };
	...
	<script type="text/javascript">
        function getChartData() {
            ...
            $.ajax({
                type : "post",
                async : false, //同步执行
                url : "${pageContext.request.contextPath}/fnpie03_chfs.do?institution=" + institution + "&date_start=" + date_start + "&date_end=" + date_end,
                data : {},
