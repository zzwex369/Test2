...
<head>
<title>儿童系统管理率</title>
<!--  http://localhost:7002/fybjxt/chart/etpie03_xtgl.jsp -->
...
<body>
	...
	<div style="height: 400px; width: 980px;">
		...
		<div style="float:right;margin-top: 200px;width: 330px;"><img src="../image/chart_picture/et003_xtgll.png" /></div>
	</div>
            ...
            function DrawEChart(ec) {
                ...
                var options = {
                	    ...
                	    legend: {
                	        //orient : 'vertical',
                	        //x : 'left',
                	        data:['按要求接受过管理的儿童数', '按要求未接受过管理的儿童数']
                	    },
                	    toolbox: {
                	        show : true,
                	        feature : {
                	    ...
                	    series : [
                	        {
                	            ...
                	            center: ['50%', '60%'],
                	            data:[
                	                {value:350, name:'按要求接受过管理的儿童数'},
                	                {value:50, name:'按要求未接受过管理的儿童数'}
                	            ]
                	        }
                	    ]
                };
	...
	<script type="text/javascript">
        function getChartData() {
            ...
            $.ajax({
                type : "post",
                async : false, //同步执行
                url : "${pageContext.request.contextPath}/etpie03_xtgl.do?institution=" + institution + "&date_start=" + date_start + "&date_end=" + date_end,
                data : {},
