...
<head>
    ...
    function window_onload() {
		...
		if ( Installed ){
	 		...
	 		CreateDisplayViewerEx("100%", "100%", "../../grf/msbb/tlzh.grf", "../../data/msbb/xmlCustomer_tlzh.jsp?dateStr="+dateStr
	    	+"&dateEnd="+dateEnd
	    	+"&chargetype="+chargetype+"&date_status="+date_status+"&address_status="+address_status+"&address="
	    	+address+"&institution="+institution+"&sczt="+sczt+"&scjg="+scjg, true, "");
		}
	}
	</script>
</head>
