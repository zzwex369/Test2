...
String d201Field=i==4?"d201_02":"d201_01";
	...
	sql.append("select "+address[0]+",d601.d601_01 from d601 d601 where to_char(d601.d601_03,'yyyy-mm-dd')>='"+dateStr+"' and to_char(d601.d601_03,'yyyy-mm-dd')<='"+dateEnd+"' and  ");
	...
	sql.append("where f2.f502_02= b.f501_01 and substr("+address[1]+",0,6)=ms_03.d201_01 group by ms_03.d201_04, ms_03.d201_01) b ");
	...
	sql.append("select e.e601_01,e601_84,"+address[4]+" from e601 e where substr("+address[4]+",0,to_number("+i+"))='"+code+"' and e601_24='1' and ");
	sql.append("to_char(e601_84,'yyyy-mm-dd')>='"+dateStr+"' and to_char(e601_84,'yyyy-mm-dd')<='"+dateEnd+"') e1,(");
	...
	sql.append("select e.e601_01,e.e601_84,"+address[4]+" from e601 e where substr("+address[4]+",0,to_number("+i+"))='"+code+"' and e601_24='1' ");
	sql.append("and to_char(e601_84,'yyyy-mm-dd')>='"+dateStr+"' and to_char(e601_84,'yyyy-mm-dd')<='"+dateEnd+"' and (e601_57='阳性' or e601_59='阳性')) ");
	...
	sql.append("and substr("+address[2]+",0,4) !='4113' and f601_41='1') f1 group by xq,code) a left join (select code,xq,");
	...
	sql.append("and to_char(f601_71,'yyyy-mm-dd')<='"+dateEnd+"' and substr("+address[2]+",0,4) !='4113' and f601_41='1') f1,");
	...
	sql.append("select nvl(a.code,b.code)as code, nvl(a.xq,b.xq)as xq ,nvl(a.e601,0)as e601, nvl(b.e601_1,0)as e601_1 from(");
	sql.append("select count(e1.e601_01) as e601 ,xq ,code from(select e.e601_01,e601_84,e.e601_49,");
	sql.append("'南阳市外 ' as xq,'666666' as code from e601 e where to_char(");
	sql.append("e601_84,'yyyy-mm-dd')>='"+dateStr+"' and to_char(e601_84,'yyyy-mm-dd')<='"+dateEnd+"' ");
	sql.append("and substr("+address[4]+",0,4)!='4113' and e601_24='1') e1 group by xq ,code) a left join(");
	sql.append("select count(e1.e601_01) as e601_1 ,xq,code from(select e.e601_01,e.e601_84,e601_49,");
	sql.append("'南阳市外 ' as xq,'666666' as code from e601 e where  to_char(e601_84,'yyyy-mm-dd')>=");
	sql.append("'"+dateStr+"' and to_char(e601_84,'yyyy-mm-dd')<='"+dateEnd+"' and substr");
