    ...
    function window_onload() {
		if (_gr_platform.indexOf("64") > 0)
			...
			{	 
		    	...
		    	var statisticalMode = document.getElementById("statisticalMode").value;
		    	CreateDisplayViewerEx("100%", "100%", "../../grf/etbj/etsl/0-6sltjb.grf", 
		    	"../../data/etbj/etsl/xmlCustomer_0-6sltjb.jsp?code="+code+"&codeType="
		    	+codeType+"&dateStr="+dateStr+"&dateEnd="+dateEnd+"&statisticalMode="+statisticalMode,
		    	 true, "");
...
<body onload="window_onload()">
	...
	<input type="hidden" id="codeType" value="${param.codeType}"/>
	<input type="hidden" id="statisticalMode" value="${param.statisticalMode}"/>
