...
<div>
	<table id="excel" width="75%" align="center" style="font-size: 14px">
		<tr>
			<td colspan="12">
				<h3 align="center">河南省 《出生医学证明》辖区出生情况统计</h3>
			</td>
		</tr>
		<!-- tr>
		...
		<tr>
			<td colspan="6">
				<table border="2" width="100%" borderColor="#000000"  align="center"
					...
					<tr>
						<td><p align="center">地区</p></td>
						<td><p align="center">出生总数</p></td>
						<td><p align="center">男</p></td>
						<td><p align="center">女</p></td>
						<td><p align="center">男孩比例</p></td>
						<td><p align="center">女孩比例</p></td>
					</tr>  	
					<c:forEach var="listGender" items="${birthTemps}" varStatus="i">
						<tr height="20">
							<td><p align="center">${listGender.areaCode_Zh }</p></td>
							<td><p align="center">${listGender.t01 }</p></td>
							<td><p align="center">${listGender.t02 }</p></td>
							<td><p align="center">${listGender.t03 }</p></td>
							<td><p align="center">${listGender.t04 }</p></td>
							<td><p align="center">${listGender.t05 }</p></td>
						</tr>
					</c:forEach>
				</table>
			</td>
