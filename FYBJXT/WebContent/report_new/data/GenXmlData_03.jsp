    ...
    try
    {
        ...
        while( rs.next() ) 
        {
            ...
            for (int i=1; i<=ColCount; i++){
            	if(rsmd.getColumnLabel(i).equals("F302_45")){
            		XmlText.append('<');
                            	...
                            	for (int n = 0; n < sq.length; n++) {
                            		if(sq[n].equals("1")){
                            			...
                            			if(sq[n].equals("2")){
                            				...
                            				sq[n] = "聋";
                            				XmlText.append(sq[n]+",");
                            			}else if(sq[n].equals("4")){
                            				sq[n] = "哑";
                            				XmlText.append(sq[n]+",");
                            			}else if(sq[n].equals("5")){
                            				sq[n] = "精神病";
                            				XmlText.append(sq[n]+",");
                            			}else if(sq[n].equals("6")){
                            				sq[n] = "先天性智力低下";
                            				XmlText.append(sq[n]+",");
                            			}else if(sq[n].equals("7")){
                            				sq[n] = "先天性心脏病";
                            				XmlText.append(sq[n]+",");
                            			}else if(sq[n].equals("8")){
                            				sq[n] = "血友病";
                            				XmlText.append(sq[n]+",");
                            			}else if(sq[n].equals("9")){
                            				sq[n] = "糖尿病";
                            				XmlText.append(sq[n]+",");
                            			}else if(sq[n].equals("99")){
                            				sq[n] = "其他";
                            				XmlText.append(sq[n]+",");
                            			}
                    ...
                    XmlText.append(rsmd.getColumnLabel(i)); //getColumnName
                    XmlText.append('>');
            	}else if(rsmd.getColumnLabel(i).equals("F302_48")){
            		XmlText.append('<');
                    XmlText.append(rsmd.getColumnLabel(i)); //getColumnName
                    XmlText.append('>');
                    ...
                    XmlText.append(rsmd.getColumnLabel(i)); //getColumnName
                    XmlText.append('>');
            	}else if(rsmd.getColumnLabel(i).equals("F302_36")){
            		XmlText.append('<');
                    XmlText.append(rsmd.getColumnLabel(i)); //getColumnName
                    XmlText.append('>');
                            	...
                            	for (int n = 0; n < sq.length; n++) {
                            		if(sq[n].equals("1")){
                            			...
                            			if(sq[n].equals("2")){
                            				...
                            				sq[n] = "性病";
                            				XmlText.append(sq[n]+",");
                            			}else if(sq[n].equals("10")){
                            				sq[n] = "癫痫";
                            				XmlText.append(sq[n]+",");
                            			}else if(sq[n].equals("11")){
                            				sq[n] = "甲亢";
                            				XmlText.append(sq[n]+",");
                            			}else if(sq[n].equals("12")){
                            				sq[n] = "先天疾患";
                            				XmlText.append(sq[n]+",");
                            			}else if(sq[n].equals("99")){
                            				sq[n] = "其他";
