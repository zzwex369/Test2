    ...
    function window_onload() {
		if (_gr_platform.indexOf("64") > 0)
			...
			{	 
		    	...
		    	var hospita=document.getElementById("hospital").value;
		    	var chargetype=document.getElementById("chargetype").value;
		    	var date_status=document.getElementById("date_status").value;
		    
		    	CreateDisplayViewerEx("100%", "100%", "../grf/xqhz.grf", "../data/xmlCustomer_20.jsp?institution="+institution+"&date_satrt="+date_satrt+"&date_end="+date_end+"&hospital="+hospital+"&chargetype="+chargetype+"&date_status="+date_status, true, "");
