    ...
    function window_onload() {
		if (_gr_platform.indexOf("64") > 0)
			...
			{	 
		    	...
		    	CreateDisplayViewerEx("100%", "100%", "../grf/cshz.grf", "../data/xmlCustomer_21.jsp?institution="+institution+"&date_satrt="+date_satrt+"&date_end="+date_end+"&hospital="+hospital+"&chargetype="+chargetype+"&date_status="+date_status, true, "");
