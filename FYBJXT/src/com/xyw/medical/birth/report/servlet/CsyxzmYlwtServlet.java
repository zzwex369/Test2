...
//@WebServlet("/CsyxzmYlwtServlet")
public class CsyxzmYlwtServlet extends HttpServlet {
...
//		String flag = request.getParameter("flag");
		...
		request.getRequestDispatcher("/report/csyxzmylwt.jsp").forward(request, response);
	}
