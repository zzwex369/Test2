...
public class PrintBirthInfoServiceNew {
	...
	public VD301 queryD301(String d301_10, ServletContext servletContext) {
		...
		try {
			...
			if(resultSet.next()) {
				...
				String d30113 = "";
				int d30104Year = Integer.parseInt(d30104.substring(0, 4));
				int d30104Month = Integer.parseInt(d30104.substring(5, 7));
				int d30104Day = Integer.parseInt(d30104.substring(8, 10));
				if(d30113String != null && !"".equals(d30113String))
				{
					int d30113Year = Integer.parseInt(d30113String.substring(0, 4));
					int d30113Month = Integer.parseInt(d30113String.substring(5, 7));
					int d30113Day = Integer.parseInt(d30113String.substring(8, 10));
					if(d30104Month > d30113Month || d30104Month == d30113Month && d30104Day > d30113Day){
						d30113 = String.valueOf(d30104Year - d30113Year);
					}else{
						d30113 = String.valueOf((d30104Year - d30113Year) - 1);
					}
				//	d30113 = String.valueOf(d30104Year - Integer.parseInt(d30113Year));
				}
				...
				{
					int d30118Year = Integer.parseInt(d30118String.substring(0, 4));
					int d30118Month = Integer.parseInt(d30118String.substring(5, 7));
					int d30118Day = Integer.parseInt(d30118String.substring(8, 10));
					if(d30104Month > d30118Month || d30104Month == d30118Month && d30104Day > d30118Day){
						d30118 = String.valueOf(d30104Year - d30118Year);
					}else{
						d30118 = String.valueOf((d30104Year - d30118Year) - 1);
					}
					//d30118 = String.valueOf(d30104Year - Integer.parseInt(d30118Year));
				}
			...
			//	String d30145 = resultSet.getString("d301_45");
				...
				String d30156 = resultSet.getString("d301_56");
				String d30157 = resultSet.getString("d301_57");
...
//				} else {
//					vd301.setD30121Zh(d30121Zh + d30146);
//				}
				...
				vd301.setD30144(d30134Zh);
				vd301.setD30145(d30135Zh);
...
//				}else
//				{
//					vd301.setD30148Zh(d30148Zh + d30149);
//				}
...
//				String d30113SString = resultSet.getString("d301_13");
				String d30113S = d30113;
//				if(d30113SString != null && !"".equals(d30113SString))
//				{
//					String d30113Year = d30113SString.substring(0, 4);
//					d30113S = String.valueOf(d30104Year - Integer.parseInt(d30113Year));
//				}
...
//				String d30118SString = resultSet.getString("d301_18");
				String d30118S = d30118;
//				if(d30118SString != null && !"".equals(d30118SString))
//				{
//					String d30118Year = d30118SString.substring(0, 4);
//					d30118S = String.valueOf(d30104Year - Integer.parseInt(d30118Year));
//				}
				...
				//String d30121ZhS = resultSet.getString("d301_21_ZH");
				...
				//String d30148ZhS = resultSet.getString("d301_48_ZH");
				...
				vd301.setD30101S(d30101S);
				vd301.setD30102S(d30102S);
				vd301.setD30103S(d30103S);
				vd301.setD30103ZhS(d30103ZhS);
				vd301.setD30104S(d30104S);
				vd301.setD30105S(d30105S);
				vd301.setD30105ZhS(d30105ZhS);
				vd301.setD30106S(d30106S);
				vd301.setD30107S(d30107S);
				vd301.setD30108S(d30108S);
				vd301.setD30109S(d30109S);
				vd301.setD30109ZhS(d30109ZhS);
				vd301.setD30110S(d30110S);
				vd301.setD30111S(d30111S);
				vd301.setD30112S(d30112S);
				vd301.setD30113S(d30113S);
				vd301.setD30114S(d30114S);
				vd301.setD30114ZhS(d30114ZhS);
				vd301.setD30115S(d30115S);
				vd301.setD30115ZhS(d30115ZhS);
				vd301.setD30116S(d30116S);
				vd301.setD30117S(d30117S);
				vd301.setD30118S(d30118S);
				vd301.setD30119S(d30119S);
				vd301.setD30119ZhS(d30119ZhS);
				vd301.setD30120S(d30120S);
				vd301.setD30120ZhS(d30120ZhS);
				vd301.setD30121S(d30121S);
				//vd301.setD30121ZhS(d30121ZhS + d30146);
				vd301.setD30122S(d30122S);
				vd301.setD30122ZhS(d30122ZhS);
				vd301.setD30123S(d30123S);
				vd301.setD30124S(d30124S);
				vd301.setD30124ZhS(d30124ZhS);
				vd301.setD30125S(d30125S);
				vd301.setD30126S(d30126S);
				vd301.setD30126ZhS(d30126ZhS);
				vd301.setD30127S(d30127S);
				vd301.setD30128S(d30128S);
				vd301.setD30129S(d30129S);
				vd301.setD30130S(d30130S);
				vd301.setD30130ZhS(d30130ZhS);
				vd301.setD30131S(d30131S);
				vd301.setD30132S(d30132S);
				vd301.setD30133S(d30133S);
				vd301.setD30134S(d30134S);
				vd301.setD30135S(d30135S);
				vd301.setD30136S(d30136S);
				
				vd301.setD30137S(d30137S);
				vd301.setD30138S(d30138S);
				vd301.setD30139S(d30139S);
				vd301.setD30140S(d30140S);
				vd301.setD30141S(d30141S);
				vd301.setD30142S(d30142S);
				vd301.setD30143S(d30143S);
				vd301.setD30144S(d30144S);
				vd301.setD30145S(d30145S);
				vd301.setD30146S(d30146S);
				vd301.setD30147S(d30147S);
				vd301.setD30148S(d30148S);
//				if(d30149S == null)
//				{
//					vd301.setD30148ZhS(d30148ZhS);
//				}else
//				{
//					vd301.setD30148ZhS(d30148ZhS + d30149S);
//				}
				vd301.setD30149S(d30149S);
				vd301.setD30150S(d30150S);
				vd301.setD30151S(d30151S);
				vd301.setD30152S(d30152S);
				vd301.setD30153S(d30153S);
				vd301.setD30154S(d30154S);
				vd301.setD30155S(d30155S);
				vd301.setD30156S(d30156S);
				vd301.setD30157S(d30157S);
				vd301.setD30158S(d30158S);
				vd301.setD30159S(d30159S);
				vd301.setD30160S(d30160S);
				vd301.setD30161S(d30161S);
				vd301.setD30162S(d30162S);
				vd301.setD30163S(d30163S);
				vd301.setD30164S(d30164S);
				vd301.setD30165S(d30165S);
				vd301.setD30166S(d30166S);
				vd301.setD30167S(d30167S);
				vd301.setD30168S(d30168S);
				vd301.setD30169S(d30169S);
				vd301.setD30170S(d30170S);
...
//				String d30113TString = resultSet.getString("d301_13");
				String d30113T = d30113;
//				if(d30113TString != null && !"".equals(d30113TString))
//				{
//					String d30113Year = d30113TString.substring(0, 4);
//					d30113T = String.valueOf(d30104Year - Integer.parseInt(d30113Year));
//				}
...
//				String d30118TString = resultSet.getString("d301_18");
				String d30118T = d30118;
//				if(d30118TString != null && !"".equals(d30118TString))
//				{
//					String d30118Year = d30118TString.substring(0, 4);
//					d30118T = String.valueOf(d30104Year - Integer.parseInt(d30118Year));
//				}
...
//				String d30121ZhT = resultSet.getString("d301_21_ZH");
...
//				String d30148ZhT = resultSet.getString("d301_48_ZH");
				...
				vd301.setD30101T(d30101T);
				vd301.setD30102T(d30102T);
				vd301.setD30103T(d30103T);
				vd301.setD30103ZhT(d30103ZhT);
				vd301.setD30104T(d30104T);
				vd301.setD30105T(d30105T);
				vd301.setD30105ZhT(d30105ZhT);
				vd301.setD30106T(d30106T);
				vd301.setD30107T(d30107T);
				vd301.setD30108T(d30108T);
				vd301.setD30109T(d30109T);
				vd301.setD30109ZhT(d30109ZhT);
				vd301.setD30110T(d30110T);
				vd301.setD30111T(d30111T);
				vd301.setD30112T(d30112T);
				vd301.setD30113T(d30113T);
				vd301.setD30114T(d30114T);
				vd301.setD30114ZhT(d30114ZhT);
				vd301.setD30115T(d30115T);
				vd301.setD30115ZhT(d30115ZhT);
				vd301.setD30116T(d30116T);
				vd301.setD30117T(d30117T);
				vd301.setD30118T(d30118T);
				vd301.setD30119T(d30119T);
				vd301.setD30119ZhT(d30119ZhT);
				vd301.setD30120T(d30120T);
				vd301.setD30120ZhT(d30120ZhT);
				vd301.setD30121T(d30121T);
//				vd301.setD30121ZhT(d30121ZhT + d30146);
				vd301.setD30122T(d30122T);
				vd301.setD30122ZhT(d30122ZhT);
				vd301.setD30123T(d30123T);
				vd301.setD30124T(d30124T);
				vd301.setD30124ZhT(d30124ZhT);
				vd301.setD30125T(d30125T);
				vd301.setD30126T(d30126T);
				vd301.setD30126ZhT(d30126ZhT);
				vd301.setD30127T(d30127T);
				vd301.setD30128T(d30128T);
				vd301.setD30129T(d30129T);
				vd301.setD30130T(d30130T);
				vd301.setD30130ZhT(d30130ZhT);
				vd301.setD30131T(d30131T);
				vd301.setD30132T(d30132T);
				vd301.setD30133T(d30133T);
				vd301.setD30134T(d30134T);
				vd301.setD30135T(d30135T);
				vd301.setD30136T(d30136T);
				
				vd301.setD30137T(d30137T);
				vd301.setD30138T(d30138T);
				vd301.setD30139T(d30139T);
				vd301.setD30140T(d30140T);
				vd301.setD30141T(d30141T);
				vd301.setD30142T(d30142T);
				vd301.setD30143T(d30143T);
				vd301.setD30144T(d30144T);
				vd301.setD30145T(d30145T);
				vd301.setD30146T(d30146T);
				vd301.setD30147T(d30147T);
				vd301.setD30148T(d30148T);
//				if(d30149T == null)
//				{
//					vd301.setD30148ZhT(d30148ZhT);
//				}else
//				{
//					vd301.setD30148ZhT(d30148ZhT + d30149T);
//				}
				vd301.setD30149T(d30149T);
				vd301.setD30150T(d30150T);
				vd301.setD30151T(d30151T);
				vd301.setD30152T(d30152T);
				vd301.setD30153T(d30153T);
				vd301.setD30154T(d30154T);
				vd301.setD30155T(d30155T);
				vd301.setD30156T(d30156T);
				vd301.setD30157T(d30157T);
				vd301.setD30158T(d30158T);
				vd301.setD30159T(d30159T);
				vd301.setD30160T(d30160T);
				vd301.setD30161T(d30161T);
				vd301.setD30162T(d30162T);
				vd301.setD30163T(d30163T);
				vd301.setD30164T(d30164T);
				vd301.setD30165T(d30165T);
				vd301.setD30166T(d30166T);
				vd301.setD30167T(d30167T);
				vd301.setD30168T(d30168T);
				vd301.setD30169T(d30169T);
				vd301.setD30170T(d30170T);
			}
