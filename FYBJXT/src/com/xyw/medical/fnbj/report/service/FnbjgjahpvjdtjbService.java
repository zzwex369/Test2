...
public class FnbjgjahpvjdtjbService {
	public List<Object> query(String date_start,String date_end,String institution,ServletContext servletContext){
		...
		try {
			...
			StringBuffer sql=new StringBuffer("select count(t.L302_01) as t1,"+
											        ...
											        "count(case when  t.L302_105 is not null and t.L302_112 is not null  and t.L302_62='1' then 'HPV检查阴性人数' end )as hpv1,"+
											        "count(case when  t.L302_105 is not null and t.L302_112 is not null  and t.L302_62='2' then 'HPV检查阳性人数' end )as hpv2,"+
											        ...
											        "count(case when  t.L302_105 is not null and t.L302_112 is not null  and t.L302_27='2' or t.L302_56='2' or t.L302_102 in('6','7','8','9','10','11','12') then '生殖道感染总人数' end )as t22,"+
											        ...
											        " from  L302 t where  to_char(t.L302_120,'yyyy-mm-dd')>=? and to_char(t.L302_120,'yyyy-mm-dd')<=?  and t.L302_59 is not null and t.L302_68 is not null");
			...
			if (resultSet.next()) {
				long hpv1 = resultSet.getLong("hpv1");//HPV检查阴性人数
				long hpv2 = resultSet.getLong("hpv2");//HPV检查阳性人数
